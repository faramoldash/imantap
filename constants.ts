...
export const TRANSLATIONS: Record<Language, any> = {
  ru: {
    ...
    contestFilterLabel: 'Конкурс',
    contestLabel: 'Конкурс',
    contestTimeLeft: 'Осталось',
    contestMyRank: 'место',
    contestViewLeaderboard: 'Рейтинг →',
    contestSubscribeToJoin: 'Оформи подписку для участия',
    contestSubscribeBtn: 'Подписаться',
    contestFinished: 'Конкурс завершён · Победители объявлены',
    contestEarnXp: 'Начните зарабатывать XP!',
  ...
  kk: {
    ...
    contestFilterLabel: 'Жарыс',
    contestLabel: 'Жарыс',
    contestTimeLeft: 'Қалды',
    contestMyRank: 'орын',
    contestViewLeaderboard: 'Рейтинг →',
    contestSubscribeToJoin: 'Қатысу үшін жазылым алыңыз',
    contestSubscribeBtn: 'Жазылу',
    contestFinished: 'Жарыс аяқталды · Жеңімпаздар жарияланды',
    contestEarnXp: 'XP жинап бастаңыз!',
