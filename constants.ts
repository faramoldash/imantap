...
export const DEFAULT_GOALS: Record<Language, string[]> = {
  kk: [
    ...
    "Пайғамбарымыздың (с.ғ.с.) өмірбаянын оқу",
  ...
  ru: [
    ...
    "Прочитать сиру (биографию) Пророка (с.а.с.)",
...
export const TRANSLATIONS: Record<Language, any> = {
  ...
  kk: {
    ...
    referralFriend: "дос",
    promoInputTitle: "Промокод енгізу",
    promoInputDesc: "Досыңның кодын енгізіп, бонус ал.",
    promoInputPlaceholder: "Досыңның коды",
    promoBtnRedeem: "Ақтау",
...
export const NAMES_99 = [
  ...
  { id: 9, arabic: "الْعَЗِيزُ", translit: "ал-Азиз", meaning: "Аса Үстем" },
  ...
  { id: 18, arabic: "الرَّзَّакъ", translit: "әр-Раззақ", meaning: "Рызық беруші" },
  ...
  { id: 25, arabic: "الْمُعِзُّ", translit: "ал-Муиз", meaning: "Мәртебе беруші" },
  { id: 26, arabic: "الْمُذِلُّ", translit: "ал-Музил", meaning: "Қор етуші" },
  { id: 27, arabic: "السَّМِيعُ", translit: "әс-Сами", meaning: "Бәрін естуші" },
  ...
  { id: 36, arabic: "الشَّККУРُ", translit: "әш-Шакур", meaning: "Шүкіршілік етуші" },
  ...
  { id: 40, arabic: "الْمُقِИТ", translit: "ал-Муқит", meaning: "Күш беруші" },
  ...
  { id: 53, arabic: "الْوَкِيلُ", translit: "ал-Уәкил", meaning: "Сенім білдірілген" },
  ...
  { id: 58, arabic: "الْمُнсِي", translit: "ал-Мухси", meaning: "Есепке алушы" },
  { id: 59, arabic: "الْمُбْدِئُ", translit: "ал-Мубди", meaning: "Бастаушы" },
  { id: 60, arabic: "الْمُعِيدُ", translit: "ал-Муid", meaning: "Қайтарушы" },
  { id: 61, arabic: "الْمُحْيِي", translit: "ал-Мухйи", meaning: "Тірілтуші" },
  { id: 62, arabic: "الْمُمِИТُ", translit: "ал-Мумит", meaning: "Өлтіруші" },
  ...
  { id: 68, arabic: "الصَّмД", translit: "әс-Самад", meaning: "Мұқтажсыз" },
  { id: 69, arabic: "الْقَадِرُ", translit: "ал-Қадир", meaning: "Күдіретті" },
  { id: 70, arabic: "الْمُқТДЕРُ", translit: "ал-Муқтадир", meaning: "Үстем" },
  { id: 71, arabic: "الْمُқаддиМ", translit: "ал-Муқаддим", meaning: "Алға қоюшы" },
  { id: 72, arabic: "الْمُؤَххИР", translit: "ал-Муаххир", meaning: "Кейін қоюшы" },
  { id: 73, arabic: "الْأَوَّл", translit: "ал-Әууәл", meaning: "Бірінші" },
  { id: 74, arabic: "الْآххИР", translit: "ал-Ахир", meaning: "Соңғы" },
  { id: 75, arabic: "الظَّاهِР", translit: "аз-Заһир", meaning: "Анық" },
  { id: 76, arabic: "الْبَاطِН", translit: "ал-Батин", meaning: "Жасырын" },
  { id: 77, arabic: "الْوَалИ", translit: "ал-Уәли", meaning: "Билік етуші" },
  { id: 78, arabic: "الْمُтЕАЛИ", translit: "ал-Мутаали", meaning: "Аса жоғары" },
  { id: 79, arabic: "الْبЕРُّ", translit: "ал-Барр", meaning: "Қайырымды" },
  { id: 80, arabic: "التَّوَّابُ", translit: "әт-Тәууаб", meaning: "Тәубені қабыл алушы" },
  { id: 81, arabic: "الْمُنТАКЫМُ", translit: "ал-Мунтақим", meaning: "Жазалаушы" },
  { id: 82, arabic: "الْعَفُوُّ", translit: "ал-Афу", meaning: "Кешірімді" },
  { id: 83, arabic: "الرَّءُوفُ", translit: "әр-Рауф", meaning: "Өте мейірімді" },
  { id: 84, arabic: "مَالِكُ الْمُلْк", translit: "Мәликул Мулк", meaning: "Патшалықтың Иесі" },
  { id: 85, arabic: "ذُو الْجَلَالِ وَالْإِКРАМ", translit: "Зул Джәләли уәл Икрам", meaning: "Ұлылық пен жомарттық Иесі" },
  { id: 86, arabic: "الْمُкСИТ", translit: "ал-Муқсит", meaning: "Әділ төреші" },
  { id: 87, arabic: "الْجӘМИУ", translit: "ал-Джами", meaning: "Жинаушы" },
  { id: 88, arabic: "الْغَنِيُّ", translit: "ал-Ғани", meaning: "Бай, Мұқтажсыз" },
  { id: 89, arabic: "الْمُғНИ", translit: "ал-Муғни", meaning: "Байытушы" },
  { id: 90, arabic: "الْمَانِУ", translit: "ал-Мани", meaning: "Тыюшы" },
  { id: 91, arabic: "الضَّарُّ", translit: "ад-Дарр", meaning: "Зиян келтіруші" },
  { id: 92, arabic: "النَّافِУ", translit: "ән-Нафи", meaning: "Пайда беруші" },
  { id: 93, arabic: "النُّورُ", translit: "ән-Нур", meaning: "Нұр" },
  { id: 94, arabic: "الْهӘДИ", translit: "ал-Һади", meaning: "Тура жолға салушы" },
  { id: 95, arabic: "الْبَدِيعُ", translit: "ал-Бади", meaning: "Ғажайып жаратушы" },
  { id: 96, arabic: "الْبӘКИ", translit: "ал-Бақи", meaning: "Мәңгілік" },
  { id: 97, arabic: "الْوَарИС", translit: "ал-Уарис", meaning: "Мұрагер" },
  { id: 98, arabic: "الرَّШИД", translit: "әр-Рашид", meaning: "Тура жол көрсетуші" },
  { id: 99, arabic: "الصَّбУР", translit: "әс-Сабур", meaning: "Аса Сабырлы" }
];
...
export const BADGES = [
  ...
  { id: 'taraweeh_star', icon: '🕌', name_ru: 'Звезда Таравиха', name_kk: 'Таравих жұлдызы' },
